...
module Bundler
 ...
 dir = File.dirname(file)
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/haml-3.1.1/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/haml-3.1.1/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/json-1.5.1-java/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/flickraw-0.8.4/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/tilt-1.3.1/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/tilt-1.3.1/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/addressable-2.2.6/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/dm-core-1.1.0/lib")
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/rack-1.3.0/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/rack-1.3.0/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/sinatra-1.2.6/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/appengine-rack-0.0.13/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/appengine-apis-0.0.24/lib")
